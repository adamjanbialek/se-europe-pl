    ...
    return (
        <main >
            <section className={'section-contrains tables-page'}>
                <div>
                    <h1 className={'page-title'}>PRZEGLĄD ZAMÓWIEŃ</h1>
                    <p className={'paragraph paragraph--medium'}>Tutaj uzyskasz przegląd wszystkich zamówień złożonych przez Twoją firmę.
                        Kliknij na dowolny numer zamówienia, aby uzyskać więcej informacji na temat tego zamówienia i jego zawartości.
                        Skopiuj dowolne zamówienie bezpośrednio do sklepu internetowego.</p>
                    <p className={'paragraph paragraph--medium'}>Kliknij numer artykułu, aby wyświetlić dostawy tego produktu.</p>
